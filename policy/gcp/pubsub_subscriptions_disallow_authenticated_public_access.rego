...
package rpe.policy.pubsub_subscriptions_disallow_authenticated_public_access

#####
# Policy metadata
#####

description = "Disallow unauthenticated public access for Pub/Sub subscriptions"
