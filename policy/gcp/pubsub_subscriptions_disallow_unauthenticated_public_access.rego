...
package rpe.policy.pubsub_subscriptions_disallow_unauthenticated_public_access

#####
# Policy metadata
#####

description = "Disallow authenticated public access for Pub/Sub subscriptions"

applies_to = ["pubsub.googleapis.com/Subscription"]
